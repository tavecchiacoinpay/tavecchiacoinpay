...
By default, tavecchiacoinpayd will dump mempool on shutdown and
...
class MempoolPersistTest(TavecchiacoinPayTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(2)
        # Give tavecchiacoinpayd a second to reload the mempool
        ...
        self.log.debug("Prevent tavecchiacoinpayd from writing mempool.dat to disk. Verify that `savemempool` fails")
