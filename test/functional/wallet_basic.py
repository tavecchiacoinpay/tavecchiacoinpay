...
class WalletTest(TavecchiacoinPayTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 TCP from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 TCP with subtract fee from amount
        ...
        # Sendmany 10 TCP with subtract fee from amount
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/tavecchiacoinpay/tavecchiacoinpay/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6
