...
# TestNode: A peer we use to send messages to tavecchiacoinpayd, and store responses.
...
class CompactBlocksTest(TavecchiacoinPayTestFramework):
    ...
    # This test actually causes tavecchiacoinpayd to (reasonably!) disconnect us, so do this last.
    ...
    # tavecchiacoinpayd's choice of nonce.
    ...
    # Test that tavecchiacoinpayd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for tavecchiacoinpayd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # tavecchiacoinpayd will not send blocktxn responses for blocks whose height is
