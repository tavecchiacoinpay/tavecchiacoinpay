...
#if defined(NDEBUG)
# error "TavecchiacoinPay cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "TavecchiacoinPay Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s TCP additional fees, %d delta bytes\n",
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    if (nHeight == 1) return 22999999950 * COIN;
...
void ThreadScriptCheck() {
    RenameThread("tavecchiacoinpay-scriptch");
