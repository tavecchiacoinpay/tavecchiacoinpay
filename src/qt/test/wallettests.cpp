...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<TavecchiacoinPayAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_tavecchiacoinpay-qt -platform xcb      # Linux
//     src/qt/test/test_tavecchiacoinpay-qt -platform windows  # Windows
//     src/qt/test/test_tavecchiacoinpay-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = TavecchiacoinPayUnits::formatWithUnit(unit, balance, false, TavecchiacoinPayUnits::separatorAlways);
    ...
    // Amount input
    TavecchiacoinPayAmountField* amountInput = receiveCoinsDialog.findChild<TavecchiacoinPayAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: tavecchiacoinpay:")) != -1);
