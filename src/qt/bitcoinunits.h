...
/** TavecchiacoinPay unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class TavecchiacoinPayUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit TavecchiacoinPayUnits(QObject *parent);

    /** TavecchiacoinPay units.
      @note Source: https://en.tavecchiacoinpay.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        TCP,
...
typedef TavecchiacoinPayUnits::Unit TavecchiacoinPayUnit;
