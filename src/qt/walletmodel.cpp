...
WalletModel::SendCoinsReturn WalletModel::prepareTransaction(WalletModelTransaction &transaction, const CCoinControl& coinControl)
{
    ...
    for (const SendCoinsRecipient &rcp : recipients)
    {
        ...
        {   // User-entered tavecchiacoinpay address / amount:
...
WalletModel::SendCoinsReturn WalletModel::sendCoins(WalletModelTransaction &transaction)
{
...

    {
        ...
        for (const SendCoinsRecipient &rcp : transaction.getRecipients())
        {
            ...
            else if (!rcp.message.isEmpty()) // Message from normal tavecchiacoinpay:URI (tavecchiacoinpay:123...?message=example)
...
bool WalletModel::bumpFee(uint256 hash)
{
    ...
    questionString.append(TavecchiacoinPayUnits::formatHtmlWithUnit(getOptionsModel()->getDisplayUnit(), old_fee));
    questionString.append("</td></tr><tr><td>");
    questionString.append(tr("Increase:"));
    questionString.append("</td><td>");
    questionString.append(TavecchiacoinPayUnits::formatHtmlWithUnit(getOptionsModel()->getDisplayUnit(), new_fee - old_fee));
    questionString.append("</td></tr><tr><td>");
    questionString.append(tr("New fee:"));
    questionString.append("</td><td>");
    questionString.append(TavecchiacoinPayUnits::formatHtmlWithUnit(getOptionsModel()->getDisplayUnit(), new_fee));
