...
{
    BOOST_CHECK(TestSplitHost("www.tavecchiacoinpay.org", "www.tavecchiacoinpay.org", -1));
    BOOST_CHECK(TestSplitHost("[www.tavecchiacoinpay.org]", "www.tavecchiacoinpay.org", -1));
    BOOST_CHECK(TestSplitHost("www.tavecchiacoinpay.org:80", "www.tavecchiacoinpay.org", 80));
    BOOST_CHECK(TestSplitHost("[www.tavecchiacoinpay.org]:80", "www.tavecchiacoinpay.org", 80));
