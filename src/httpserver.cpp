...
{
    RenameThread("tavecchiacoinpay-http");
...
{
    RenameThread("tavecchiacoinpay-httpworker");
    queue->Run();
}
...
void StopHTTPServer()
{
    ...
    if (eventBase) {
        ...
        // (see discussion in https://github.com/tavecchiacoinpay/tavecchiacoinpay/pull/6990)
