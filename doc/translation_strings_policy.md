...
This document provides guidelines for internationalization of the TavecchiacoinPay Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `tavecchiacoinpay_en.ts` remains unchanged.
