TavecchiacoinPay Core version 0.9.2.1 is now available from:

  https://tavecchiacoinpay.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 TCP to 0.01 TCP
...
- Fix "Start tavecchiacoinpay on system login"
