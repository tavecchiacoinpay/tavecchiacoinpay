Download URL: https://sourceforge.net/projects/tavecchiacoinpay/files/TavecchiacoinPay/tavecchiacoinpay-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 TCP fee schedule (users still pay 0.01 TCP per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #tavecchiacoinpay00 - #tavecchiacoinpay99
