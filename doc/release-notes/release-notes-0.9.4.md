TavecchiacoinPay Core version 0.9.4 is now available from:

  https://tavecchiacoinpay.org/bin/0.9.4/
...
this update is incompatible with the TavecchiacoinPay system and could lead to consensus
forks.

TavecchiacoinPay Core released binaries from https://tavecchiacoinpay.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~tavecchiacoinpay/+archive/ubuntu/tavecchiacoinpay
- A third-party or self-compiled TavecchiacoinPay Core

upgrade to TavecchiacoinPay Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
