TavecchiacoinPay Core version 0.10.3 is now available from:

  <https://tavecchiacoinpay.org/bin/tavecchiacoinpay-core-0.10.3/>
...
(see https://github.com/tavecchiacoinpay/tavecchiacoinpay/pull/6793, as well as the 0.11.0
