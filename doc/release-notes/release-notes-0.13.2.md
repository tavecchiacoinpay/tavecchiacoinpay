TavecchiacoinPay Core version 0.13.2 is now available from:

  <https://tavecchiacoinpay.org/bin/tavecchiacoinpay-core-0.13.2/>
...
- #8908 `4a974b2` Update tavecchiacoinpay-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow tavecchiacoinpay-tx to create v2 transactions (btcdrak)
