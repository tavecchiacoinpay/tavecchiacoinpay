TavecchiacoinPay version 0.5.4 is now available for download at:
http://sourceforge.net/projects/tavecchiacoinpay/files/TavecchiacoinPay/tavecchiacoinpay-0.5.4/
...
http://gitorious.org/tavecchiacoinpay/tavecchiacoinpayd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix TavecchiacoinPay-Qt notifications under Growl 1.3.
Increase required age of TavecchiacoinPay-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxTavecchiacoinPay properly when installing TavecchiacoinPay-Qt over it. (Windows)
