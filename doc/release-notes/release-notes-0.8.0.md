TavecchiacoinPay-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/tavecchiacoinpay/files/TavecchiacoinPay/tavecchiacoinpay-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the TavecchiacoinPay
...
New/changed settings (command-line or tavecchiacoinpay.conf file)
--------------------------------------------------------
