TavecchiacoinPay version 0.6.2 is now available for download at:
http://sourceforge.net/projects/tavecchiacoinpay/files/TavecchiacoinPay/tavecchiacoinpay-0.6.2/
...
Fixed https://github.com/tavecchiacoinpay/tavecchiacoinpay/issues/1065, a bug that
