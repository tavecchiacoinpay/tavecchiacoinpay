TavecchiacoinPay Core version 0.10.4 is now available from:

  <https://tavecchiacoinpay.org/bin/tavecchiacoinpay-core-0.10.4/>
...
- #6953 `43c2789` Split tavecchiacoinpay-tx into its own package
- #6953 `dfe0d4d` Include tavecchiacoinpay-tx binary on Debian/Ubuntu
